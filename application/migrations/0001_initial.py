# Generated by Django 4.0.4 on 2022-06-16 18:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('max_price', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Максимальная стоимость')),
                ...
                ('status', models.CharField(choices=[('new', 'Новый'), ('renovating', 'Ремонтируется'), ('renovated', 'Отремонтировано')], default='new', max_length=12, verbose_name='Статус')),
                ('result_image', models.ImageField(blank=True, upload_to='', verbose_name='Конечный результат')),
